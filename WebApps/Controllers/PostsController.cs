...
namespace WebApps.Controllers
{
    public class PostsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PostId,Username,Time,likes")] Post post)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PostId,Username,Time,likes")] Post post)
        {
            if (id != post.PostId)
            {
                return NotFound();
